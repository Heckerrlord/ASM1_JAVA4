	...
	<div class="row">
		...
		<div class="col-4">
			<form method="post">
				...
				<button type="submit"
					formaction="http://localhost:8080/CRUDASM/user/profile"
					class="btn btn-primary btn-block btn-submit mt-4">Cập nhật
					thông tin</button>
				<div class="row" style="text-align: center">
					<div class="col-4">
						<a class="hover" href="http://localhost:8080/CRUDASM/user/sign-up">Register</a>
					</div>
					<div class="col-4">
						<a class="hover" href="http://localhost:8080/CRUDASM/user/changepass">Change password</a>
					</div>
					<div class="col-4">
						<a class="hover"
							href="http://localhost:8080/CRUDASM/user/fogotPass">Forgot
							password</a>
					</div>
				</div>
			</form>
